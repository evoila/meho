...
class IngestionJobCreate(BaseModel):
    ...
    scope_type: str | None = Field(None, description="Scope: 'global', 'type', or 'instance'")
    connector_type_scope: str | None = Field(
        None, description="Connector type for type-scoped uploads, e.g. 'vmware'"
    )
    ...
    doc_version: str | None = Field(
        None, description="Documentation version label (e.g. 'v8', 'v9')"
    )
    family_id: UUID | None = Field(None, description="Document family this job belongs to")
...
class IngestionJobFilter(BaseModel):
    ...
    scope_type: str | None = None  # global, type, instance
    connector_type_scope: str | None = None  # e.g. "vmware"
    status: str | None = None  # pending, processing, completed, failed
    job_type: str | None = None  # document, text, webhook
    doc_version: str | None = None  # filter by documentation version
    family_id: str | None = None  # filter by document family
