...
class TestGetConnectorRegularUser:
    ...
    @pytest.mark.asyncio
    def test_regular_user_sees_credentials(
        self,
...
class TestGetConnectorSuperadmin:
    ...
    @pytest.mark.asyncio
    def test_superadmin_sees_masked_credentials(
        self,
        mock_connector: Connector,
...
class TestListConnectorsSuperadmin:
    ...
    @pytest.mark.asyncio
    def test_list_connectors_masks_all_credentials(
        self,
        superadmin_in_tenant: UserContext,
    ):
...
class TestResponseSchemaCompatibility:
    ...
    @pytest.mark.asyncio
    def test_masked_response_validates_with_schema(
        self,
        mock_connector: Connector,
        superadmin_in_tenant: UserContext,
    ):
...
class TestTypedConnectorCredentials:
    ...
    @pytest.mark.asyncio
    def test_gcp_service_account_masked(
        self,
        superadmin_in_tenant: UserContext,
    ):
    ...
    @pytest.mark.asyncio
    def test_kubernetes_token_masked(
        self,
        superadmin_in_tenant: UserContext,
    ):
    ...
    @pytest.mark.asyncio
    def test_proxmox_api_token_masked(
        self,
        superadmin_in_tenant: UserContext,
    ):
...
class TestAuditTrailPreservation:
    ...
    @pytest.mark.asyncio
    def test_original_identity_preserved_after_masking(
        self,
        mock_connector: Connector,
        superadmin_in_tenant: UserContext,
    ):
