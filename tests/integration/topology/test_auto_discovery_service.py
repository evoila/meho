...
class TestAutoDiscoveryServiceSingleton:
    ...
    @pytest.mark.asyncio
    async def test_get_service_creates_instance(self):
    ...
    @pytest.mark.asyncio
    async def test_get_service_returns_same_instance(self):
        """Test that get_auto_discovery_service returns singleton."""
        service1 = await get_auto_discovery_service()
        service2 = await get_auto_discovery_service()
    ...
    @pytest.mark.asyncio
    async def test_get_service_with_custom_queue(self):
        """Test getting service with custom queue."""
        custom_queue = DiscoveryQueue()

        service = await get_auto_discovery_service(queue=custom_queue)
    ...
    async def test_get_service_disabled(self):
        ...
        service = await get_auto_discovery_service(enabled=False)
