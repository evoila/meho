...
class SOAPOperation(BaseModel):
    ...
    fault_schema: dict[str, Any] | None = None
...
class SOAPConnectorConfig(BaseModel):
    ...
    # WS-Security
    ws_security_username: str | None = None
    ws_security_password: str | None = None
    ...
    login_operation: str | None = None  # e.g., "SessionManager.Login"
    logout_operation: str | None = None  # e.g., "SessionManager.Logout"
    session_cookie_name: str | None = None  # Cookie name to track session

    # Connection settings
    timeout: int = 30  # seconds
    verify_ssl: bool = True
    endpoint_override: str | None = None  # Override endpoint from WSDL (e.g., actual host)
...
class SOAPProperty(BaseModel):
    ...
    description: str | None = None  # From XML documentation/annotation
...
class SOAPTypeDefinition(BaseModel):
    ...
    base_type: str | None = None  # Parent type if this extends another
