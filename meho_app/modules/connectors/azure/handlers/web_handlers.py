...
class WebHandlerMixin:
    ...
    async def _handle_list_azure_web_apps(
    ...
    async def _handle_get_azure_web_app(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """Get web app details."""
    ...
    async def _handle_list_azure_function_apps(
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_azure_function_app(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        if "functionapp" not in kind.lower():
            logger.warning(
                f"Site '{name}' has kind='{kind}' -- not a function app. "
                f"Returning data anyway."
            )
    ...
    async def _handle_list_azure_app_service_plans(
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        ...
        if resource_group:
            async for plan in self._web_client.app_service_plans.list_by_resource_group(resource_group):
    ...
    async def _handle_get_azure_app_service_plan(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
