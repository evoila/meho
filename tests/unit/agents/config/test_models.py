...
class TestDetectModelType:
    ...
    @pytest.mark.skip(reason="Phase 84: detect_model_type no longer returns 'embedding' type, embedding detection removed from model config")
    def test_detect_embedding_models(self) -> None:
        """Embedding models should be detected."""
        pass
...
class TestModelConfig:
    ...
    @pytest.mark.skip(reason="Phase 84: ModelConfig.is_embedding property removed, embedding models not tracked in agent config")
    def test_is_embedding_property(self) -> None:
        """is_embedding should return True for embedding models."""
        pass
