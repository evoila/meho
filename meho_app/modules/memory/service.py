...
class MemoryService:
    ...
    def __init__(self, repository: MemoryRepository, embedding_provider) -> None:
    ...
    async def _merge_memory(
        ...
        existing_conf_value = existing.confidence_level
    ...
    async def search(
        ...
        for model, similarity in raw_results:
            # Confidence boost
            conf_boost = CONFIDENCE_BOOST.get(model.confidence_level, 1.0)
