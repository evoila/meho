...
class TemplateValidator:
    ...
    def validate_template(
        ...
        text_template: str,
        tag_rules: List[str],
        issue_detection_rule: Optional[str] = None
    ) -> tuple[bool, List[str]]:
        """
        ...
        try:
            ...
            errors.append(f"Invalid text_template: {str(e)}")
        ...
        for i, rule in enumerate(tag_rules):
            try:
                ...
                errors.append(f"Invalid tag_rule[{i}] '{rule}': {str(e)}")
        ...
        if issue_detection_rule:
            try:
                ...
                errors.append(f"Invalid issue_detection_rule: {str(e)}")
