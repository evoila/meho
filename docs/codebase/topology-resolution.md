...
created in the unified initial migration
`meho_app/alembic/versions/0001_init.py` (post-Goal-#294 consolidation).
...
- Cascade delete semantics:
  `meho_app/alembic/versions/0001_init.py` (search for the topology table block).
