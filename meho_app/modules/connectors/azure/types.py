...
ARM_RESOURCE_ID = "ARM resource ID"
...
AZURE_TYPES = [
    ...
    TypeDefinition(
        ...
        category="compute",
        properties=[
            {"name": "id", "type": "string", "description": ARM_RESOURCE_ID},
            {"name": "name", "type": "string", "description": "VM name"},
            {"name": "location", "type": "string", "description": AZURE_REGION},
            {"name": "resource_group", "type": "string", "description": RESOURCE_GROUP_NAME},
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "size_gb", "type": "integer", "description": "Disk size in GB"},
            {
                "name": "sku_name",
                "type": "string",
                "description": "SKU (Premium_LRS, Standard_LRS, etc.)",
            },
            {
                "name": "disk_state",
                "type": "string",
                "description": "Disk state (Attached, Unattached, etc.)",
            },
        ],
    ),
    # Container Types
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "provisioning_state", "type": "string", "description": PROVISIONING_STATE},
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "resource_group", "type": "string", "description": RESOURCE_GROUP_NAME},
            {
                ...
                "type": "array",
                "description": "Address space CIDR ranges",
            },
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            },
            {
                ...
                "type": "array",
                "description": "Enabled service endpoints",
            },
        ],
    ),
    TypeDefinition(
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {
                "name": "frontend_ip_count",
                "type": "integer",
                "description": "Number of frontend IP configurations",
            },
            {
                "name": "backend_pool_count",
                "type": "integer",
                "description": "Number of backend pools",
            },
        ],
    ),
    # Storage Types
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "resource_group", "type": "string", "description": RESOURCE_GROUP_NAME},
            {
                "name": "sku_name",
                "type": "string",
                "description": "SKU (Standard_LRS, Premium_LRS, etc.)",
            },
            {
                "name": "kind",
                "type": "string",
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "default_host_name", "type": "string", "description": "Default hostname"},
            {
                "name": "runtime_stack",
                "type": "string",
                "description": "Runtime stack (e.g., PYTHON|3.11)",
            },
        ],
    ),
    TypeDefinition(
    ...
    TypeDefinition(
        ...
        properties=[
            {"name": "id", "type": "string", "description": ARM_RESOURCE_ID},
            {"name": "name", "type": "string", "description": RESOURCE_GROUP_NAME},
            {"name": "location", "type": "string", "description": AZURE_REGION},
            {"name": "provisioning_state", "type": "string", "description": PROVISIONING_STATE},
            {"name": "tags", "type": "object", "description": "User-defined tags"},
        ],
