          ...
          <div className="relative bg-surface rounded-2xl border border-white/10 shadow-2xl">
            ...
            <div className="flex items-end gap-2 p-2">
              <textarea
                ...
                placeholder={(() => {
                  if (isWarRoomProcessing) return 'MEHO is processing...';
                  if (disabled) return 'Respond to the approval request...';
                  if (sessionMode === 'ask') return 'Ask a question about your infrastructure...';
                  return 'Ask MEHO anything...';
                })()}
                rows={1}
                disabled={isDisabled}
