...
class OpenAPIParser:
    ...
    def _resolve_ref(  # NOSONAR (cognitive complexity)
    ...
    def _extract_parameter_metadata(  # NOSONAR (cognitive complexity)
        ...
        if not is_swagger:
            ...
            if request_body:
                ...
                for content_type in [CONTENT_TYPE_JSON, "*/*"]:
    ...
    def _extract_body_fields(
        self, resolved_schema: dict[str, Any], metadata: dict[str, Any], _spec_dict: dict[str, Any]
    ) -> None:
    ...
    def _extract_body_schema(  # NOSONAR (cognitive complexity)
        self, operation: dict[str, Any], spec_dict: dict[str, Any], is_swagger: bool = False
    ) -> dict[str, Any]:
        """
        ...
        for content_type in [CONTENT_TYPE_JSON, "*/*", "application/vnd.api+json"]:
    ...
    def _extract_response_schema(  # NOSONAR (cognitive complexity)
        self, operation: dict[str, Any], spec_dict: dict[str, Any], is_swagger: bool = False
    ) -> dict[str, Any]:
        """
    ...
    def _extract_type_properties_shallow(
        self, schema_def: dict[str, Any]
    ) -> list[dict[str, Any]]:  # NOSONAR (cognitive complexity)
    ...
    def _infer_schema_category(self, name: str, _schema_def: dict[str, Any]) -> str:
