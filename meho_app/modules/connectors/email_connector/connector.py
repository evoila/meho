...
from meho_app.modules.connectors.email_connector.handlers import (
...
from meho_app.modules.connectors.email_connector.providers.base import (
    EmailMessage,
    EmailProvider,
)
from meho_app.modules.connectors.email_connector.providers.generic_http import GenericHTTPProvider
from meho_app.modules.connectors.email_connector.providers.mailgun import MailgunProvider
from meho_app.modules.connectors.email_connector.providers.sendgrid import SendGridProvider
from meho_app.modules.connectors.email_connector.providers.ses import SESProvider
from meho_app.modules.connectors.email_connector.providers.smtp import SMTPProvider
...
class EmailConnector(
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            if self.default_recipients:
                ...
                from meho_app.modules.connectors.email_connector.handlers.email_handlers import (
                    _jinja_env,
                    html_to_plaintext,
                )
                ...
                # Safe (direct-use-of-jinja2): server-controlled email template, not user input
    ...
    async def _execute_operation(
        ...
        try:
            result: OperationResult = await handler(parameters)
