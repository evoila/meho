...
class LookupTopologyAction(BaseModel):
    ...
    cross_connectors: bool = Field(default=True, description="Follow SAME_AS edges across connectors")
...
class StoreMemoryAction(BaseModel):
    ...
    memory_type: str = Field(default="config", description="Type: entity, pattern, outcome, or config")
