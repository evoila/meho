...
import type { Endpoint, UpdateEndpointRequest } from '@/api/types';
...
export function EndpointEditorModal({ connectorId, endpoint, onClose, onSuccess }: Readonly<EndpointEditorModalProps>) {
  ...
  const updateMutation = useMutation({
    mutationFn: async (request: UpdateEndpointRequest) => {
      return await connectorsClient.updateEndpoint(connectorId, endpoint.id, request);
    },
    onSuccess: () => {
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  <label className={clsx(
                    ...
                    />
                    <span className={clsx("text-sm font-medium", isEnabled ? "text-text-secondary" : "text-red-400")}>
