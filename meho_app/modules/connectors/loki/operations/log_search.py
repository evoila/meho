        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": False,
                "description": "Kubernetes namespace to filter logs by",
            },
            {
                "name": "pod",
                "type": "string",
                "required": False,
                "description": "Pod name to filter logs by",
            },
            {
                "name": "service",
                "type": "string",
                "required": False,
                "description": "Service name to filter logs by (maps to service_name label)",
            },
            {
                "name": "container",
                "type": "string",
            ...
            },
            {
                ...
                "type": "object",
                "required": False,
                "description": "Arbitrary key:value label pairs for filtering",
            },
            {
                "name": "severity",
                "type": "string",
