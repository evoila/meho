...
class LogSearchHandlerMixin:
    ...
    async def _query_range_log(self, logql: str, params: dict) -> dict: ...  # type: ignore[empty-body]

    async def _query_log(self, logql: str, params: dict) -> dict: ...  # type: ignore[empty-body]
