...
async def _seed_skill(
    ...
    async with session_maker() as session:
        ...
        if existing is None:
            ...
            existing.content = content  # type: ignore[assignment]  # SQLAlchemy ORM attribute assignment
            existing.summary = summary  # type: ignore[assignment]  # SQLAlchemy ORM attribute assignment
            existing.description = description  # type: ignore[assignment]  # SQLAlchemy ORM attribute assignment
            existing.updated_at = now  # type: ignore[assignment]  # SQLAlchemy ORM attribute assignment
...
INFRASTRUCTURE_PERF_SKILL_DESCRIPTION = "Cross-system diagnosis pattern for performance issues from application layer down to infrastructure"
...
INCIDENT_CHANGE_SKILL_DESCRIPTION = (
    "Broader change correlation covering infrastructure changes alongside CI/CD deployments"
)
