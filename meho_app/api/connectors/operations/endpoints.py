...
async def list_endpoints(
    ...
    safety_level: Annotated[str | None, Query()] = None,
...
@router.patch(
    "/{connector_id}/endpoints/{endpoint_id}",
...
async def test_endpoint(
    ...
    user: Annotated[UserContext, Depends(get_current_user)],  # noqa: PT028 -- intentional default value
):
    """
