...
import type { ConflictStrategy, ImportConnectorsResponse } from '@/api/types';
...
export function ImportConnectorsModal({ onClose, onSuccess }: ImportConnectorsModalProps) {
  ...
  const handleImport = useCallback(async () => {
    ...
    try {
      ...
      // Call API
      const response = await connectorsClient.importConnectors({
  ...
  }, [canImport, file, password, conflictStrategy, connectorsClient, onSuccess, onClose]);
