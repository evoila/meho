...
class EC2HandlerMixin:
    ...
    async def _handle_get_instance(self: "AWSConnector", params: dict[str, Any]) -> dict[str, Any]:  # type: ignore[misc]
        """
        ...
        def _get_instance() -> dict[str, Any]:
            ...
            if reservations and reservations[0].get("Instances"):
                result: dict[str, Any] = reservations[0]["Instances"][0]
                return result
            return {}
    ...
    async def _handle_list_security_groups(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
    ...
    async def _handle_get_security_group(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """
