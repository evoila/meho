...
MSG_NO_HISTOGRAM_DATA = "no histogram data"
...
class ServiceHandlerMixin:
    ...
    async def _query_range(self, query: str, time_range: TimeRange) -> list: ...  # type: ignore[empty-body]

    async def _query_instant(self, query: str) -> list: ...  # type: ignore[empty-body]

    async def _find_service_label(
        self, service_name: str
    ) -> str | None:  # NOSONAR (cognitive complexity)
        """
