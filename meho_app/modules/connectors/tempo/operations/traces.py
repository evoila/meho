...
DESC_MAXIMUM_NUMBER_OF_TRACES_TO = "Maximum number of traces to return. Default: 20"
DESC_TIME_RANGE_TO_SEARCH_EG = "Time range to search (e.g., '1h', '30m', '6h'). Default: 1h"
SERVICE_NAME_TO_FILTER_TRACES_BY = "Service name to filter traces by"
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": False,
                "description": SERVICE_NAME_TO_FILTER_TRACES_BY,
            },
            {
                "name": "operation",
                "type": "string",
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": DESC_TIME_RANGE_TO_SEARCH_EG,
            },
            {
                "name": "limit",
                "type": "integer",
                "required": False,
                "description": DESC_MAXIMUM_NUMBER_OF_TRACES_TO,
            },
        ],
