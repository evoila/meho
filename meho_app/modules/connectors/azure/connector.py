...
class AzureConnector(
    ...
    async def connect(self) -> bool:
        ...
        try:
            logger.info(
                f"Connecting to Azure subscription: {self._subscription_id}"
            )
            ...
            logger.info(
                f"Connected to Azure subscription: {self._subscription_id}"
            )
            return True
    ...
    async def test_connection(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Azure connection test passed: subscription {self._subscription_id}"
            )
            return True
    ...
    async def execute(self, operation_id: str, parameters: dict[str, Any]) -> OperationResult:
        ...
        try:
            ...
            logger.error(
                f"{operation_id} failed: {error_info['message']}", exc_info=True
            )
            return OperationResult(
                success=False,
