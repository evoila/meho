...
def extract_preferred_keywords(
    context: str | None, question: str | None
...
def score_snippet(
    snippet: str, context: str, keywords: list[str]
...
def extract_verbatim_snippet(  # NOSONAR (cognitive complexity)
