...
@router.patch(
    ...
    responses={
        ...
        403: {"description": "Only the session owner can change visibility"},
        404: {"description": "Session not found"},
        500: {"description": "Failed to update session visibility"},
    },
)
...
@router.patch(
    ...
    response_model=SessionResponse,
    responses={
        400: {"description": "Invalid session_mode: '...'. Must be 'ask' or 'agent'."},
        403: {"description": "Access denied"},
        404: {"description": "Session not found"},
        500: {"description": "Failed to update session mode"},
    },
)
