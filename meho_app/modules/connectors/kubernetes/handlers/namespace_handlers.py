...
class NamespaceHandlerMixin:
    ...
    def _serialize_namespace(self, _ns: Any) -> dict[str, Any]:
        return {}

    def _serialize_configmap(self, _cm: Any) -> dict[str, Any]:
        return {}

    def _serialize_secret(self, _secret: Any, decode: bool = False) -> dict[str, Any]:
        return {}
    ...
    async def _list_namespaces(self, _params: dict[str, Any]) -> list[dict[str, Any]]:
