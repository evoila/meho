...
@router.post("/{connector_id}/memories", response_model=MemoryResponse, status_code=201)
...
@router.get("/{connector_id}/memories", response_model=list[MemoryResponse])
async def list_memories(
    ...
    confidence_level: ConfidenceLevel | None = Query(
        default=None, description="Filter by confidence level"
    ),
    created_after: datetime | None = Query(
        default=None, description="Filter: created after this date"
    ),
    created_before: datetime | None = Query(
        default=None, description="Filter: created before this date"
    ),
...
@router.get("/{connector_id}/memories/{memory_id}", response_model=MemoryResponse)
...
@router.patch("/{connector_id}/memories/{memory_id}", response_model=MemoryResponse)
...
@router.delete("/{connector_id}/memories/{memory_id}", response_model=DeleteResponse)
...
@router.post("/{connector_id}/memories/search", response_model=list[MemorySearchResult])
...
@router.delete("/{connector_id}/memories/bulk", response_model=BulkDeleteResponse)
