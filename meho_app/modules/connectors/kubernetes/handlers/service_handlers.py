...
class ServiceHandlerMixin:
    ...
    def _serialize_service(self, _svc: Any) -> dict[str, Any]:
        return {}

    def _serialize_ingress(self, _ing: Any) -> dict[str, Any]:
        return {}

    def _serialize_endpoints(self, _ep: Any) -> dict[str, Any]:
        return {}

    def _serialize_network_policy(self, _np: Any) -> dict[str, Any]:
        return {}
