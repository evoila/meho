"""
Database session management for OpenAPI Service.

Provides database access for connector/endpoint storage.
"""
...
def get_engine() -> AsyncEngine:
    """
    Get or create the OpenAPI database engine (module-level singleton).
    ...
    if _engine is None:
        # OpenAPI service uses the same database as the BFF (shared database architecture)
...
def create_session_maker() -> async_sessionmaker:
    """
    Create an async session maker for the OpenAPI database.
