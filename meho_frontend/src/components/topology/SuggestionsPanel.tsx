  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden p-6">
      ...
      {discoveryResult && (
        ...
        >
          {(() => {
            if (discoveryResult.suggestions_created === 0) return 'No new matches found';
            const plural = discoveryResult.suggestions_created > 1 ? 'es' : '';
            return `Found ${discoveryResult.suggestions_created} new match${plural}!`;
          })()}
