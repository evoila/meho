...
export function ConnectorList({ onSelectConnector }: ConnectorListProps) {
...
function ConnectorCard({ connector, health, onClick }: ConnectorCardProps) {
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          {(() => {
            ...
            return (
              <span className={clsx(
                ...
                {connectorType === 'vmware' ? <Server className="h-3 w-3" /> : connectorType === 'soap' ? <FileCode className="h-3 w-3" /> : <Globe className="h-3 w-3" />}
          ...
          <span className={clsx(
            ...
            connector.default_safety_level === 'safe' ? "bg-green-400/10 text-green-400 border-green-400/20" :
              connector.default_safety_level === 'caution' ? "bg-amber-500/10 text-amber-400 border-amber-500/20" :
                "bg-red-500/10 text-red-400 border-red-500/20"
          )}>
            {connector.default_safety_level === 'safe' ? <ShieldCheck className="h-3 w-3" /> :
              connector.default_safety_level === 'caution' ? <Shield className="h-3 w-3" /> :
