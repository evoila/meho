...
class TestConcreteNode:
    ...
    @pytest.mark.asyncio
    def test_concrete_node_run_returns_next_node(self) -> None:
        ...
        node = TestNode()
        state: dict[str, Any] = {}
        result = node.run(state, MagicMock(), MagicMock())
    ...
    @pytest.mark.asyncio
    def test_concrete_node_run_returns_terminal(self) -> None:
        ...
        node = FinalNode()
        result = node.run({}, MagicMock(), MagicMock())
...
class TestNodeGenericTyping:
    ...
    @pytest.mark.asyncio
    def test_node_mutates_typed_state(self) -> None:
