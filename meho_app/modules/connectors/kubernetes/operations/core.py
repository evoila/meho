...
NAMESPACE_THE_POD_IS_IN = "Namespace the pod is in"
NAME_OF_THE_NODE = "Name of the node"
NAME_OF_THE_POD = "Name of the pod"
...
CORE_OPERATIONS = [
    ...
    OperationDefinition(
        ...
        category="core",
        parameters=[
            {"name": "name", "type": "string", "required": True, "description": NAME_OF_THE_POD},
            {
                "name": "namespace",
                "type": "string",
                "required": True,
                "description": NAMESPACE_THE_POD_IS_IN,
            },
        ],
    ...
    OperationDefinition(
        ...
        category="core",
        parameters=[
            {"name": "name", "type": "string", "required": True, "description": NAME_OF_THE_NODE},
        ],
