...
async def infer(
    ...
    *,
    ...
    if model is not None:
        ...
        agent = _get_agent()  # type: ignore[assignment]  # Generic type variance
    ...
    try:
        result = await asyncio.wait_for(
            agent.run(
                ...
                model_settings=model_settings if model_settings else None,  # type: ignore[arg-type]  # dict is valid ModelSettings at runtime
            ),
...
async def infer_structured(  # NOSONAR (cognitive complexity)
    prompt: str,
