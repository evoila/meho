 ...
 *
 * The full pipeline (build-time Vite vs. container-startup envsubst, why
 * /config.js is served with no-store, the nginx exact-match short-circuit
 * and add_header shadowing quirks) is documented in
 * docs/codebase/first-run-experience.md#runtime-config-propagation.
 */
