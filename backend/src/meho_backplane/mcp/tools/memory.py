...
register_mcp_tool(
    definition=ToolDefinition(
        ...
        description=(
            ...
            "specific target. As a first reflex, search here before "
            "answering a question this tenant's memory may already "
            "answer and before repeating a preference the operator "
            "stated once — not only when the operator explicitly asks "
            "you to look. "
...
register_mcp_tool(
    definition=ToolDefinition(
        ...
        description=(
            ...
            "a target-specific gotcha. Reach for this proactively — the "
            "moment you learn a durable preference, convention, or "
            "gotcha (especially right after resolving an error or a "
            "retry), record it here before the session ends and the "
            "context is lost, not only when the operator asks you to "
            "remember it. "
