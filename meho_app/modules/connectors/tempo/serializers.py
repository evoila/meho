...
def _extract_attribute(attrs: list[dict[str, Any]], key: str) -> Any:
    """
...
def serialize_trace_search(data: dict, limit: int = 20) -> dict:
    """
...
def serialize_full_trace(data: dict) -> dict:
    """
...
def serialize_span_details(span_data: dict[str, Any], resource_attrs: list[dict[str, Any]]) -> dict:
    """
