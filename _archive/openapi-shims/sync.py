...
from meho_app.modules.openapi.connectors.vmware.operations import (
    VMWARE_OPERATIONS,
    VMWARE_OPERATIONS_VERSION,
)
from meho_app.modules.openapi.connectors.base import OperationDefinition
from meho_app.modules.openapi.schemas import ConnectorOperationCreate
...
def _format_vmware_operation_as_text(op: OperationDefinition, connector_name: str = "VMware") -> str:
    """
...
async def sync_vmware_operations_if_needed(
    ...
    """
    from meho_app.modules.openapi.repository import ConnectorOperationRepository
...
async def update_connector_operations_version(
    ...
    """
    from meho_app.modules.openapi.models import ConnectorModel
