...
def _fake_reduce_data_handler(_deps: object, args: dict[str, object]) -> str:
...
class TestCallOperationToReduceToMarkdown:
    ...
    @pytest.mark.asyncio
    def test_pipeline_produces_markdown_from_cached_data(
        ...
        with (
            ...
            result = node.run(state, emitter, call_result)
    ...
    @pytest.mark.asyncio
    def test_small_data_bypasses_aggregation(self) -> None:
        ...
        def fake_handler(_deps: object, args: dict) -> str:
        ...
        with (
            ...
            result = node.run(state, None, call_result)
...
class TestMultiTableCrossJoinIntegration:
    ...
    @pytest.mark.asyncio
    def test_cross_table_join_via_real_query_engine(
        self,
...
class TestFullWorkflowMarkdownFindings:
    ...
    async def test_execute_workflow_returns_markdown_findings(self) -> None:
        ...
        class FakeSearchIntentNode:
            ...
            def run(self, state: Any, emitter: Any) -> Any:
                intent = MagicMock()
        ...
        class FakeSearchOpsNode:
            ...
            def run(self, state: Any, emitter: Any, query: str) -> list:
        ...
        class FakeSelectOpNode:
            ...
            def run(self, state: Any, emitter: Any, operations: list) -> Any:
                obj = SelectionResult()
        ...
        class FakeCallOpNode:
            ...
            def run(self, state: Any, emitter: Any, operation_id: str, parameters: dict) -> dict:
                return {
                    "data_available": False,
                    "table": "pods",
                    "row_count": 50,
        ...
        class FakeReduceDataNode:
            ...
            def run(self, state: Any, emitter: Any, call_result: dict) -> str:
    ...
    async def test_execute_workflow_error_handling(self) -> None:
        ...
        class FakeCallOpNode:
            ...
            def run(self, state: Any, emitter: Any, op_id: str, params: dict) -> dict:
                return {}
