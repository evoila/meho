...
def create_extraction_agent() -> Agent:
    ...
    return Agent(
        ...
        output_type=ExtractionResult,  # type: ignore[arg-type]  # pydantic-ai output_type accepts Pydantic models
        ...
        async with session_maker() as session:
            ...
            for cf in connector_findings:
                try:
                    ...
                    extraction: ExtractionResult = result.output  # type: ignore[assignment]  # pydantic-ai returns typed output at runtime
