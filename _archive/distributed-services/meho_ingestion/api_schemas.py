...
class WebhookResponse(BaseModel):
    ...
    event_id: Optional[str] = Field(None, description="Assigned event ID for tracking")
...
class IngestionStatusResponse(BaseModel):
    ...
    chunks_created: Optional[int] = Field(None, description="Number of knowledge chunks created")
