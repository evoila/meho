...
class TestKubernetesBackendDispatch:
    ...
    async def test_dispatch_creates_namespaced_job(self) -> None:
        ...
        assert call_args.kwargs.get("namespace") == "meho-workers" or call_args[1].get(
            "namespace"
        ) == "meho-workers"
...
class TestKubernetesBackendCancel:
    ...
    async def test_cancel_deletes_job(self) -> None:
        ...
        assert call_args.kwargs.get("name") == "meho-ingest-test" or call_args[1].get(
            "name"
        ) == "meho-ingest-test"
...
class TestCloudRunBackendCancel:
    ...
    async def test_cancel_calls_cancel_execution(self) -> None:
        ...
        assert (
            call_args.kwargs.get("name") == "exec-001"
            or (call_args[0] and call_args[0][0] and "exec-001" in str(call_args))
        )
