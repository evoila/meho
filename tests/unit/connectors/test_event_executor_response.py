...
async def test_response_channel_success(response_config, mock_connector):
    ...
    with (
        ...
        patch("meho_app.modules.connectors.keycloak_user_checker.KeycloakUserChecker"),
        patch(
...
@pytest.mark.asyncio
def test_investigation_skips_response_when_no_config():
...
@pytest.mark.asyncio
def test_investigation_skips_response_when_empty_result():
