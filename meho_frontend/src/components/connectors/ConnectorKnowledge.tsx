...
import { DocumentPreviewModal } from '../../features/knowledge/components/DocumentPreviewModal';
            ...
            {documents.map((doc) => {
              ...
              return (
                <motion.div
                  ...
                  className={clsx(
                    'glass rounded-xl p-5 border border-white/10 hover:border-primary/30 transition-all group',
