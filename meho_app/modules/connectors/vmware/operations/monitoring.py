...
INTERVAL_REALTIME_PAST_DAY_PAST_WEEK = "Interval: realtime, past_day, past_week"
NAME_OF_CLUSTER = "Name of cluster"
...
MONITORING_OPERATIONS = [
    OperationDefinition(
        ...
        parameters=[],
        example="list_alarms()",
        response_entity_type="Alarm",
        response_identifier_field="key",
        response_display_name_field="alarm_name",
    ),
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": INTERVAL_REALTIME_PAST_DAY_PAST_WEEK,
            },
        ],
        example="get_vm_performance(vm_name='web-01', interval='past_day')",
        response_entity_type="PerformanceMetrics",
        response_identifier_field="vm_name",
        response_display_name_field="vm_name",
    ),
    OperationDefinition(
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": "Filter by entity type: vm, host, cluster",
            },
        ],
        example="get_events(limit=100, entity_type='vm')",
        response_entity_type="Event",
        response_identifier_field="key",
        response_display_name_field="full_formatted_message",
    ),
    OperationDefinition(
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of entity (VM, host, etc.)",
            },
            {
                "name": "entity_type",
                "type": "string",
                "required": True,
                "description": "Type: vm, host, cluster, datastore",
            },
        ],
    ...
    OperationDefinition(
        ...
        response_entity_type="ResourceUsage",
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of VM to check overhead for",
            },
        ],
    ...
    OperationDefinition(
        ...
        name="Get Datastore Capacity and Status",
        description="""Get datastore capacity and status information.

RETURNS:
- Datastore type (VMFS, NFS, vsan, etc.)
- Total capacity (GB)
- Free space (GB)
...
⚠️ IOPS/LATENCY NOT AVAILABLE FROM DATASTORE DIRECTLY:
Datastores are NOT valid performance providers in vSphere's PerformanceManager API.

TO GET DATASTORE IOPS/LATENCY:
Call get_detailed_host_performance with metrics=["datastore"] on a host that accesses the datastore.
Example: get_detailed_host_performance(host_name='esxi-01', metrics=['datastore'])
This returns read/write IOPS, latency, and throughput for all datastores the host accesses.""",
        category="monitoring",
        parameters=[
            {
                "name": "datastore_name",
        ...
        example="get_datastore_performance(datastore_name='datastore1')",
        response_entity_type="DatastoreCapacity",
        response_identifier_field="datastore_name",
        response_display_name_field="datastore_name",
    ),
    # =========================================================================
...
- Getting disk statistics or network statistics for a VM""",
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": "Time interval: realtime, 5min, 1hour, 6hour, 12hour, 24hour, 7day (default: realtime)",
            },
            {
                "name": "metrics",
                "type": "array",
                "required": False,
                "description": "Metric groups to include: cpu, memory, disk, network (default: all)",
            },
        ],
        example="get_detailed_vm_performance(vm_name='web-01', interval='1hour', metrics=['disk', 'network'])",
        response_entity_type="DetailedPerformanceMetrics",
        response_identifier_field="vm_name",
        response_display_name_field="vm_name",
    ),
    OperationDefinition(
...
- Comparing host performance within a cluster""",
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": "Time interval: realtime, 5min, 1hour (default: realtime)",
            },
        ],
        example="get_cluster_detailed_performance(cluster_name='Production', interval='5min')",
        response_entity_type="ClusterPerformanceMetrics",
        response_identifier_field="cluster_name",
        response_display_name_field="cluster_name",
    ),
    OperationDefinition(
...
Different vCenter versions and configurations may have different metrics available.""",
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Type of entity: vm, host, datastore",
            },
            {
                "name": "entity_name",
                "type": "string",
        ...
        response_entity_type="MetricDefinition",
        response_identifier_field="key",
