...
async def ingest_wsdl(  # NOSONAR (cognitive complexity)
    connector_id: str,
    ...
    async with session_maker() as session:
        ...
        try:
            ...
            operations, metadata, type_definitions = await ingester.ingest_wsdl(  # type: ignore[misc]
                wsdl_url=request.wsdl_url,
            ...
            for type_def in type_definitions:
                ...
                type_creates.append(
                    SoapTypeDescriptorCreate(
                        ...
                        properties=[p.model_dump() for p in type_def.properties],
    ...
    async with session_maker() as session:
        ...
        try:
            async with ClientClass(config) as client:
                response = await client.call(  # type: ignore[misc]
