...
class VMHandlerMixin:
    ...
    def _find_snapshot(self, vm: Any, snapshot_name: str) -> Any | None:
        return None
    ...
    def _format_vm_from_properties(self, obj: Any) -> dict[str, Any]:
        """
    ...
    def _format_template_from_properties(self, props: dict[str, Any]) -> dict[str, Any]:
