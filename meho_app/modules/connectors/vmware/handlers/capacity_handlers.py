...
class CapacityHandlerMixin:
    ...
    async def _get_cluster_overcommitment(self, params: dict[str, Any]) -> dict:
    ...
    async def _get_datastore_utilization(self, params: dict[str, Any]) -> list[dict]:
    ...
    async def _get_host_load_distribution(self, params: dict[str, Any]) -> dict:
        ...
        for host in cluster.host or []:
            ...
            try:
                ...
                hosts_data.append(
                    {"host_name": host_name, "status": "error", "error": str(e)}
                )
