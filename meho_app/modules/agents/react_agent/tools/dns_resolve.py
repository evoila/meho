...
Use to find IP addresses, mail servers, service endpoints, or verify DNS configuration."""
    ...
    async def execute(
        ...
        for rtype in tool_input.record_types:
            ...
            try:
                result = await resolver.query(tool_input.hostname, rtype_upper)  # type: ignore[call-overload]  # aiodns stubs incomplete for query overloads
...
def _parse_dns_result(
    rtype: str, result: Any
