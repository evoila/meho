...
class AKSHandlerMixin:
    ...
    async def _handle_list_azure_aks_clusters(
        ...
        if resource_group:
            async for cluster in self._container_client.managed_clusters.list_by_resource_group(resource_group):
    ...
    async def _handle_get_azure_aks_cluster(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_get_azure_aks_cluster_health(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_aks_node_pools(
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_azure_aks_node_pool(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_get_azure_aks_credentials(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        return {
            ...
            "api_server_access_profile": {
                ...
                ) if cluster.api_server_access_profile else [],
    ...
    async def _handle_list_azure_aks_upgrades(
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
