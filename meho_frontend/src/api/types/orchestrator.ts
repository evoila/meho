...
/**
 * Phase 110: Emitted as the routing LLM reasons about the investigation plan.
 * Streams thinking text progressively from second 0 (D-01).
 */
export interface OrchestratorThinkingEvent {
  type: 'orchestrator_thinking';
  agent: string;
  data: {
    /** New chunk of thinking text */
    content: string;
