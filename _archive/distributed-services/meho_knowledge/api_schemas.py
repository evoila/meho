...
class ChunkCreateRequest(BaseModel):
    ...
    # Lifecycle fields
    knowledge_type: KnowledgeType = Field(default=KnowledgeType.DOCUMENTATION, description="Type of knowledge (DOCUMENTATION, PROCEDURE, EVENT)")
    priority: int = Field(default=0, ge=-100, le=100, description="Search ranking priority")
    expires_at: Optional[datetime] = Field(default=None, description="Expiration timestamp for temporary knowledge (e.g., events, notices)")
