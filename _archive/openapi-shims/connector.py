...
from meho_app.modules.openapi.connectors.base import (
    BaseConnector,
    OperationResult,
    OperationDefinition,
    TypeDefinition,
)
from meho_app.modules.openapi.connectors.vmware.operations import VMWARE_OPERATIONS
from meho_app.modules.openapi.connectors.vmware.types import VMWARE_TYPES

# Import all handler mixins
from meho_app.modules.openapi.connectors.vmware.handlers import (
    VMHandlerMixin,
    HostHandlerMixin,
    ClusterHandlerMixin,
    StorageHandlerMixin,
...
# Import serializers
from meho_app.modules.openapi.connectors.vmware.serializers import (
...
# Import helpers
from meho_app.modules.openapi.connectors.vmware.helpers import (
    find_vm,
    find_cluster,
    find_host,
    find_datastore,
...
class VMwareConnector(
    ...
    async def execute(
        ...
        handlers = {
            ...
            "get_detailed_datastore_performance": self._get_detailed_datastore_performance,
