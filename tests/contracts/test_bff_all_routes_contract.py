...
class TestBFFKnowledgeRoutesContract:
    ...
    def test_knowledge_chunk_response_compatible_with_knowledge_service(self):
        ...
        # BFF enriches responses with connector metadata from its own data
        bff_enrichment_fields = {"connector_name", "connector_type"}
        missing_in_knowledge = bff_fields - knowledge_fields - bff_enrichment_fields
