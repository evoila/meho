...
# nosemgrep: direct-use-of-jinja2 -- server-controlled email templates with trusted content
...
class SendEmailHandlerMixin:
    ...
    async def _handle_send_email(
        ...
        # nosemgrep: direct-use-of-jinja2 -- server-controlled email template rendering
