        ...
        async with session_maker() as session:
            ...
            output = {
                "results": [
                    {
                        "text": r.get("text", "")[:500],
                        "score": r.get("score", r.get("rerank_score", r.get("similarity", 0.0))),
...
async def run_stdio() -> None:
    ...
    await mcp_server.run(transport="stdio")  # type: ignore[func-returns-value]  # FastMCP.run() is async but typed as returning None
