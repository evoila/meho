...
from meho_ingestion.models import EventTemplate
from meho_ingestion.schemas import EventTemplateCreate, EventTemplateUpdate, EventTemplateFilter
...
class EventTemplateRepository:
    ...
    async def get_template_by_id(self, template_id: str) -> Optional[EventTemplate]:
        """
