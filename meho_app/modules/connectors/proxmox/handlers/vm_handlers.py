...
MSG_VMID_REQUIRED = "vmid is required"
MSG_VMID_SNAPNAME_REQUIRED = "vmid and snapname are required"
...
class VMHandlerMixin:
    ...
    def _list_vms(self, params: dict[str, Any]) -> list[dict]:
    ...
    def _get_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Get detailed information about a specific VM."""
        vmid = params.get("vmid")
        node = params.get("node")

        if not vmid:
            raise ValueError(MSG_VMID_REQUIRED)
    ...
    def _get_vm_status(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _start_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Start a VM."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _stop_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Stop a VM (hard stop)."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _shutdown_vm(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _restart_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Reboot a VM."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _reset_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Hard reset a VM."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _suspend_vm(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _resume_vm(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _get_vm_config(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _clone_vm(self, params: dict[str, Any]) -> dict[str, Any]:
        """Clone a VM."""
        vmid = params.get("vmid")
    ...
    def _migrate_vm(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _list_vm_snapshots(self, params: dict[str, Any]) -> list[dict]:
    ...
    def _create_vm_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        if not vmid or not snapname:
            raise ValueError(MSG_VMID_SNAPNAME_REQUIRED)
    ...
    def _delete_vm_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _rollback_vm_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
