...
class OrchestratorSkillModel(Base):  # type: ignore[misc,valid-type]
    """
    ...
    skill_type = Column(String(50), nullable=False, server_default="orchestrator")  # "orchestrator" or "connector"
    connector_type = Column(String(50), nullable=True)  # e.g., "kubernetes", null for orchestrator skills
    created_at = Column(
