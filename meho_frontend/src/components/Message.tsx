 ...
 */
function CodeBlockWrapper({ children, ...props }: { children?: ReactNode; [key: string]: unknown }) {
...
export function Message({ role, content, isStreaming, isProgressUpdate, senderName, showSenderName }: MessageProps) {
