...
class TestFactorySkillMap:
    ...
    def test_factory_type_skill_map_has_all_typed_connectors(self):
        ...
        expected_types = {
            "alertmanager", "argocd", "confluence", "email", "gcp",
            "github", "jira", "kubernetes", "loki", "prometheus",
            "proxmox", "tempo", "vmware",
        }
...
@pytest.mark.skip(reason="Phase 84: _resolve_skill_content_from_db was inlined into create_agent, no longer a standalone function")
class TestResolveSkillContentFromDB:
    """Tests for _resolve_skill_content_from_db() function."""

    def test_resolve_skill_content_from_db_none_returns_none(self):
        """Neither generated nor custom skill returns None."""
        pass

    def test_resolve_skill_content_from_db_empty_strings_returns_none(self):
        """Empty strings (falsy) return None."""
        pass

    def test_resolve_skill_content_from_db_generated_only(self):
        """Only generated_skill returns that content directly."""
        pass

    def test_resolve_skill_content_from_db_custom_only(self):
        """Only custom_skill returns it with the customization header."""
        pass

    def test_resolve_skill_content_from_db_both(self):
        """Both generated and custom returns concatenation with separator."""
        pass
