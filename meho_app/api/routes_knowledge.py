...
async def search_knowledge(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Knowledge search failed") from e
...
async def get_document_detail(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to load document detail") from e
...
async def list_family_versions(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to load versions") from e
