...
class CloudBuildHandlerMixin:
    ...
    async def _handle_get_build(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_list_build_triggers(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_build_logs(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """
    ...
    async def _handle_cancel_build(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_retry_build(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
