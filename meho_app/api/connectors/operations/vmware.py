...
async def create_vmware_connector(
    request: CreateVMwareConnectorRequest, user: UserContext = Depends(get_current_user)
):
    """
    ...
    try:
        async with session_maker() as session:
            ...
            connector_create = ConnectorCreate(
                ...
                # nosemgrep: tainted-url-host -- admin-configured vCenter host (connector setup requires admin auth)
