...
def serialize_vm_properties(vm: Any) -> Dict[str, Any]:
    ...
    if hasattr(vm, 'runtime') and vm.runtime:
        ...
        result["runtime"] = {
            ...
            "connection_state": str(runtime.connectionState) if hasattr(runtime, 'connectionState') else None,
            ...
            "max_memory_usage": runtime.maxMemoryUsage if hasattr(runtime, 'maxMemoryUsage') else None,
        }
    ...
    if hasattr(vm, 'guest') and vm.guest:
        ...
        result["guest"] = {
            ...
            "tools_status": str(guest.toolsRunningStatus) if hasattr(guest, 'toolsRunningStatus') else None,
    ...
    if hasattr(vm, 'summary') and vm.summary:
        if hasattr(vm.summary, 'quickStats') and vm.summary.quickStats:
            ...
            result["summary"] = {
                ...
                "overall_status": str(vm.summary.overallStatus) if hasattr(vm.summary, 'overallStatus') else None,
            }
    ...
    if hasattr(vm, 'capability') and vm.capability:
        cap = vm.capability
        result["capability"] = {
            "snapshot_operations_supported": cap.snapshotOperationsSupported if hasattr(cap, 'snapshotOperationsSupported') else None,
            "multiple_snapshots_supported": cap.multipleSnapshotsSupported if hasattr(cap, 'multipleSnapshotsSupported') else None,
            "can_power_off": cap.poweredOffSnapshotsSupported if hasattr(cap, 'poweredOffSnapshotsSupported') else None,
        }
    ...
    if hasattr(vm, 'snapshot') and vm.snapshot:
        result["snapshot"] = {
            "current_snapshot": vm.snapshot.currentSnapshot.name if hasattr(vm.snapshot, 'currentSnapshot') and vm.snapshot.currentSnapshot else None,
            "root_snapshot_count": len(vm.snapshot.rootSnapshotList) if hasattr(vm.snapshot, 'rootSnapshotList') else 0,
        }
    ...
    if hasattr(vm, 'storage') and vm.storage:
        ...
        result["storage"] = {
            "per_datastore_usage": [
                ...
                for usage in (storage.perDatastoreUsage if hasattr(storage, 'perDatastoreUsage') else [])
    ...
    if hasattr(vm, 'resourceConfig') and vm.resourceConfig:
        ...
        result["resource_config"] = {
            "cpu_allocation": rc.cpuAllocation.reservation if hasattr(rc, 'cpuAllocation') and rc.cpuAllocation else None,
            "memory_allocation": rc.memoryAllocation.reservation if hasattr(rc, 'memoryAllocation') and rc.memoryAllocation else None,
        }
...
def serialize_host_properties(host: Any) -> Dict[str, Any]:
    ...
    if hasattr(host, 'runtime') and host.runtime:
        ...
        result["runtime"] = {
            "connection_state": str(runtime.connectionState) if hasattr(runtime, 'connectionState') else None,
            "power_state": str(runtime.powerState) if hasattr(runtime, 'powerState') else None,
            "maintenance_mode": runtime.inMaintenanceMode if hasattr(runtime, 'inMaintenanceMode') else None,
    ...
    if hasattr(host, 'summary') and host.summary:
        if hasattr(host.summary, 'hardware') and host.summary.hardware:
            ...
            result["hardware_summary"] = {
                ...
                "memory_mb": (hw.memorySize // (1024 * 1024)) if hasattr(hw, 'memorySize') and hw.memorySize else None,
            }
        ...
        if hasattr(host.summary, 'quickStats') and host.summary.quickStats:
            ...
            result["stats"] = {
                "cpu_usage_mhz": qs.overallCpuUsage if hasattr(qs, 'overallCpuUsage') else None,
                "memory_usage_mb": qs.overallMemoryUsage if hasattr(qs, 'overallMemoryUsage') else None,
                "uptime_seconds": qs.uptime if hasattr(qs, 'uptime') else None,
            }
        
        result["overall_status"] = str(host.summary.overallStatus) if hasattr(host.summary, 'overallStatus') else None
    ...
    if hasattr(host, 'hardware') and host.hardware:
        ...
        result["hardware_detailed"] = {
            "system_info": {
                "vendor": hw.systemInfo.vendor if hasattr(hw, 'systemInfo') and hw.systemInfo else None,
                "model": hw.systemInfo.model if hasattr(hw, 'systemInfo') and hw.systemInfo else None,
            },
    ...
    if hasattr(host, 'config') and host.config:
        config = host.config
        result["config"] = {
            "hyperthread_available": config.hyperThread.available if hasattr(config, 'hyperThread') and config.hyperThread else None,
            "hyperthread_active": config.hyperThread.active if hasattr(config, 'hyperThread') and config.hyperThread else None,
        }
    ...
    if hasattr(host, 'capability') and host.capability:
        ...
        result["capability"] = {
            ...
            "storage_vmotion_supported": cap.storageVMotionSupported if hasattr(cap, 'storageVMotionSupported') else None,
...
def serialize_datastore_properties(ds: Any) -> Dict[str, Any]:
    ...
    if hasattr(ds, 'summary') and ds.summary:
        ...
        result["summary"] = {
            ...
            "capacity_gb": (summary.capacity // (1024**3)) if hasattr(summary, 'capacity') and summary.capacity else None,
            "free_space_gb": (summary.freeSpace // (1024**3)) if hasattr(summary, 'freeSpace') and summary.freeSpace else None,
            "accessible": summary.accessible if hasattr(summary, 'accessible') else None,
            "multiple_host_access": summary.multipleHostAccess if hasattr(summary, 'multipleHostAccess') else None,
    ...
    if hasattr(ds, 'capability') and ds.capability:
        cap = ds.capability
        result["capability"] = {
            "directory_hierarchy_supported": cap.directoryHierarchySupported if hasattr(cap, 'directoryHierarchySupported') else None,
            "raw_disk_mappings_supported": cap.rawDiskMappingsSupported if hasattr(cap, 'rawDiskMappingsSupported') else None,
            "per_file_thin_provisioning_supported": cap.perFileThinProvisioningSupported if hasattr(cap, 'perFileThinProvisioningSupported') else None,
        }
    
    # 4. Hosts with access to this datastore (array)
    if hasattr(ds, 'host') and ds.host:
        result["host_count"] = len(ds.host)
        result["hosts"] = [h.key.name if hasattr(h.key, 'name') else None for h in ds.host][:50]  # Limit to 50
    ...
    if hasattr(ds, 'iormConfiguration') and ds.iormConfiguration:
        ...
        result["iorm_configuration"] = {
            ...
            "congestion_threshold": iorm.congestionThreshold if hasattr(iorm, 'congestionThreshold') else None,
        }
...
def serialize_cluster_properties(cluster: Any) -> Dict[str, Any]:
    ...
    if hasattr(cluster, 'configuration') and cluster.configuration:
        ...
        result["configuration"] = {
            "drs_enabled": config.drsConfig.enabled if hasattr(config, 'drsConfig') and config.drsConfig else None,
            "drs_behavior": str(config.drsConfig.defaultVmBehavior) if hasattr(config, 'drsConfig') and config.drsConfig else None,
            "ha_enabled": config.dasConfig.enabled if hasattr(config, 'dasConfig') and config.dasConfig else None,
            "ha_host_monitoring": config.dasConfig.hostMonitoring if hasattr(config, 'dasConfig') and config.dasConfig else None,
        }
    ...
    if hasattr(cluster, 'summaryEx') and cluster.summaryEx:
        ...
        result["summary"] = {
            ...
            "num_effective_hosts": summary.numEffectiveHosts if hasattr(summary, 'numEffectiveHosts') else None,
            "total_cpu_mhz": summary.totalCpu if hasattr(summary, 'totalCpu') else None,
            "total_memory_mb": (summary.totalMemory // (1024 * 1024)) if hasattr(summary, 'totalMemory') else None,
        }
    ...
    if hasattr(cluster, 'hciConfig') and cluster.hciConfig:
        result["hci_config"] = {
            "workflow_state": str(cluster.hciConfig.workflowState) if hasattr(cluster.hciConfig, 'workflowState') else None,
        }
...
def serialize_network_properties(network: Any) -> Dict[str, Any]:
    ...
    if hasattr(network, 'summary') and network.summary:
        result["summary"] = {
            "accessible": network.summary.accessible if hasattr(network.summary, 'accessible') else None,
...
def serialize_dvs_properties(dvs: Any) -> Dict[str, Any]:
    ...
    if hasattr(dvs, 'summary') and dvs.summary:
        ...
        result["summary"] = {
            ...
            "product_info": summary.productInfo.version if hasattr(summary, 'productInfo') and summary.productInfo else None,
            "host_member_count": len(summary.hostMember) if hasattr(summary, 'hostMember') and summary.hostMember else 0,
        }
    ...
    if hasattr(dvs, 'config') and dvs.config:
        ...
        result["config"] = {
            ...
            "num_standalone_ports": config.numStandalonePorts if hasattr(config, 'numStandalonePorts') else None,
        }
    ...
    if hasattr(dvs, 'capability') and dvs.capability:
        cap = dvs.capability
        result["capability"] = {
            "dv_port_group_operation_supported": cap.dvPortGroupOperationSupported if hasattr(cap, 'dvPortGroupOperationSupported') else None,
            "dvs_operation_supported": cap.dvsOperationSupported if hasattr(cap, 'dvsOperationSupported') else None,
        }
    
    # 5. Runtime
    if hasattr(dvs, 'runtime') and dvs.runtime:
        result["runtime"] = {
            "host_member_runtime_count": len(dvs.runtime.hostMemberRuntime) if hasattr(dvs.runtime, 'hostMemberRuntime') and dvs.runtime.hostMemberRuntime else 0,
        }
...
def serialize_portgroup_properties(pg: Any) -> Dict[str, Any]:
    ...
    if hasattr(pg, 'config') and pg.config:
        ...
        result["config"] = {
            ...
            "default_port_config": str(config.defaultPortConfig)[:100] if hasattr(config, 'defaultPortConfig') else None,
        }
...
def serialize_resource_pool_properties(pool: Any) -> Dict[str, Any]:
    ...
    if hasattr(pool, 'config') and pool.config:
        config = pool.config
        result["config"] = {
            "cpu_allocation_mhz": config.cpuAllocation.reservation if hasattr(config, 'cpuAllocation') and config.cpuAllocation else None,
            "memory_allocation_mb": config.memoryAllocation.reservation if hasattr(config, 'memoryAllocation') and config.memoryAllocation else None,
        }
...
def serialize_datacenter_properties(dc: Any) -> Dict[str, Any]:
    ...
    if hasattr(dc, 'datastoreFolder') and dc.datastoreFolder:
        result["datastore_folder"] = dc.datastoreFolder.name if hasattr(dc.datastoreFolder, 'name') else None
    
    if hasattr(dc, 'networkFolder') and dc.networkFolder:
        result["network_folder"] = dc.networkFolder.name if hasattr(dc.networkFolder, 'name') else None
