...
class ECSHandlerMixin:
    ...
    async def _handle_list_ecs_clusters(  # type: ignore[misc]
    ...
    async def _handle_list_ecs_services(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
    ...
    async def _handle_get_ecs_service(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """
    ...
    async def _handle_list_ecs_tasks(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
    ...
    async def _handle_get_ecs_task(self: "AWSConnector", params: dict[str, Any]) -> dict[str, Any]:  # type: ignore[misc]
        """
