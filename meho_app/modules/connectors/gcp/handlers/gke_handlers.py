...
class GKEHandlerMixin:
    ...
    def _get_cluster_parent(self: "GCPConnector", location: str | None = None) -> str:
    ...
    async def _handle_get_cluster(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
        """Get cluster details."""
    ...
    async def _handle_get_cluster_health(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        for np in cluster.node_pools or []:
            ...
            total_nodes += np.initial_node_count or 0
    ...
    async def _handle_list_node_pools(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_node_pool(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_get_cluster_credentials(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_cluster_operations(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
