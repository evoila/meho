...
class TopologyService:
    ...
    async def store_discovery(  # NOSONAR (cognitive complexity)
        self,
        ...
        try:
            ...
            for entity_input in input.entities:
                ...
                entity_id_map[entity_input.name] = (
                    db_entity.id,
                    entity_input.entity_type,
                )
    ...
    async def lookup(  # NOSONAR (cognitive complexity)
        self,
...
def get_topology_service(session: AsyncSession) -> TopologyService:
