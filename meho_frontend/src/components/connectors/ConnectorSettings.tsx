...
export default function ConnectorSettings({ connector, onUpdate, allConnectors = [] }: ConnectorSettingsProps) {
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  ...
                  {formData.login_config.login_headers && Object.keys(formData.login_config.login_headers).length > 0 ? (
                    <div className="space-y-2">
                      {Object.entries(formData.login_config.login_headers).map(([key, value], idx) => (
