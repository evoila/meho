...
class ContainerHandlerMixin:
    ...
    def _list_containers(self, params: dict[str, Any]) -> list[dict]:
    ...
    def _get_container(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _get_container_status(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _start_container(self, params: dict[str, Any]) -> dict[str, Any]:
        """Start a container."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _shutdown_container(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _restart_container(self, params: dict[str, Any]) -> dict[str, Any]:
        """Restart a container."""
        vmid = params.get("vmid")
        node = params.get("node")
    ...
    def _get_container_config(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _clone_container(self, params: dict[str, Any]) -> dict[str, Any]:
        """Clone a container."""
        vmid = params.get("vmid")
    ...
    def _migrate_container(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _list_container_snapshots(self, params: dict[str, Any]) -> list[dict]:
    ...
    def _create_container_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _delete_container_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    def _rollback_container_snapshot(self, params: dict[str, Any]) -> dict[str, Any]:
