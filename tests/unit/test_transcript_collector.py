...
class TestTranscriptCollectorStats:
    ...
    async def test_llm_call_stats(self, collector):
        ...
        assert collector._total_cost_usd == pytest.approx(0.001)
...
class TestTranscriptCollectorEventHelpers:
    ...
    @pytest.mark.asyncio
    def test_create_llm_event(self, collector):
        ...
        assert event.details.llm_duration_ms == pytest.approx(1234.5)

    @pytest.mark.asyncio
    def test_create_tool_event(self, collector):
        ...
        assert event.details.tool_duration_ms == pytest.approx(100.0)

    @pytest.mark.asyncio
    def test_create_operation_event(self, collector):
        ...
        assert event.details.http_duration_ms == pytest.approx(342.1)

    @pytest.mark.asyncio
    def test_create_sql_event(self, collector):
        ...
        assert event.details.sql_duration_ms == pytest.approx(10.5)
