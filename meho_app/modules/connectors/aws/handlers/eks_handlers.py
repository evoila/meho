...
class EKSHandlerMixin:
    ...
    async def _handle_list_eks_clusters(  # type: ignore[misc]
    ...
    async def _handle_get_eks_cluster(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """
        ...
        def _describe() -> dict[str, Any]:
            ...
            result: dict[str, Any] = response.get("cluster", {})
            return result
    ...
    async def _handle_list_eks_node_groups(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
        ...
        def _list_and_describe() -> list[dict[str, Any]]:
            ...
            for name in nodegroup_names:
                response = client.describe_nodegroup(clusterName=cluster_name, nodegroupName=name)
    ...
    async def _handle_get_eks_node_group(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
        """
        ...
        def _describe() -> dict[str, Any]:
            ...
            result: dict[str, Any] = response.get("nodegroup", {})
            return result
