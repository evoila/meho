...
class Config(BaseSettings):
    ...
    llm_model: str = Field(
        default="anthropic:claude-opus-4-6", description="Default LLM model for agents (fallback)"
    )
    ...
    streaming_agent_model: str = Field(
        default="anthropic:claude-opus-4-6", description="Model for streaming chat responses"
    )

    # Planning Agent
    planner_model: str = Field(
        default="anthropic:claude-opus-4-6", description="Model for creating execution plans"
    )

    # Execution Agent
    executor_model: str = Field(
        default="anthropic:claude-opus-4-6", description="Model for executing plan steps"
    )
