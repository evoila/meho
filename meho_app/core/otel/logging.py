...
class StructuredLogger:
    ...
    def _log(
        ...
        **attributes: Any,
        ...
        self._logger.log(level, message, exc_info=exc_info, extra={"attributes": attributes})
    ...
    def log(
        ...
        **attributes: Any,
        ...
        """
        self._log(level, message, exc_info=exc_info, **attributes)
    ...
    def debug(
        ...
        **attributes: Any,
        ...
        self._log(logging.DEBUG, message, exc_info=exc_info, **attributes)
    ...
    def info(
        ...
        **attributes: Any,
        ...
        self._log(logging.INFO, message, exc_info=exc_info, **attributes)
    ...
    def warning(
        ...
        **attributes: Any,
        ...
        self._log(logging.WARNING, message, exc_info=exc_info, **attributes)
    ...
    def warn(
        ...
        **attributes: Any,
        ...
        """Alias for warning."""
        self.warning(message, exc_info=exc_info, **attributes)
    ...
    def error(
        ...
        **attributes: Any,
        ...
        self._log(logging.ERROR, message, exc_info=exc_info, **attributes)
