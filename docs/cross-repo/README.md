...
| [`g07-vsphere-canary.md`](./g07-vsphere-canary.md) | [`evoila-bosnia/claude-rdc-hetzner-dc`](https://github.com/evoila-bosnia/claude-rdc-hetzner-dc) | Operator runbook for the G0.7 acceptance canary — ingests the consumer's checked-in `docs/vcenter-9.0/vcenter.yaml` + `vi-json.yaml` end-to-end, drives operator review, asserts the 10-query govc-parity search benchmark (Task [#408](https://github.com/evoila/meho/issues/408)) |
