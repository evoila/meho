...
async def export_session_transcript(
    ...
    format: Annotated[ExportFormat, Query()] = ExportFormat.JSON,
...
@router.post(
    ...
    responses={
        ...
        404: {"description": "No transcripts found matching criteria"},
        500: {"description": "Internal server error"},
    },
)
@limiter.limit(lambda: get_config().rate_limit_export)
async def export_transcripts_bulk(  # NOSONAR (cognitive complexity)
    request: Request,
    ...
    try:
        ...
        for transcript in transcripts:
            ...
            export_data["sessions"].append(session_data)  # type: ignore[attr-defined]
