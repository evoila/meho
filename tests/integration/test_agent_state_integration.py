...
@pytest.mark.asyncio
def test_connector_persists_across_calls(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_uuid_auto_correction_from_state(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_multi_connector_context_switching(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_endpoint_caching(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_error_learning_prevents_retry(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_workflow_tracking(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_user_preference_learning(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_cross_system_correlation(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_state_context_summary(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_state_serialization_roundtrip(dependencies):
...
@pytest.mark.integration
@pytest.mark.asyncio
def test_production_bug_scenario_fixed(dependencies):
    """
