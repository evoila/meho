...
def find_vm(content: Any, name: str) -> Any | None:
    """Find VM by name."""
...
def find_cluster(content: Any, name: str) -> Any | None:
...
def find_host(content: Any, name: str) -> Any | None:
    """Find host by name."""
    from pyVmomi import vim
...
def find_datastore(content: Any, name: str) -> Any | None:
...
def find_folder(content: Any, name: str) -> Any | None:
    """Find folder by name."""
    from pyVmomi import vim
...
def find_snapshot(vm: Any, snapshot_name: str) -> Any | None:
...
def search_snapshot_tree(snapshot_list: list, name: str) -> Any | None:
...
def find_resource_pool(content: Any, name: str) -> Any | None:
...
def find_dvs(content: Any, name: str) -> Any | None:
...
def find_network(content: Any, name: str) -> Any | None:
...
def collect_snapshots(snapshot_list: list, results: list[dict], parent: str | None = None) -> None:
