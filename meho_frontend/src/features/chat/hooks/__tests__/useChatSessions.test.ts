...
// Mock the chat client (hook now imports from @/api/clients/chat, not the monolith facade)
...
// Phase 84: useChatSessions imports config.ts which triggers keycloak-js
// initialization. The vi.mock of the chat client conflicts with the module
// graph causing "React.createContext is not a function" in the test wrapper.
// Hook needs a deeper mock of the config/keycloak dependency chain before
// these cases can be un-skipped.
