    ...
    TypeDefinition(
        ...
        properties=[
            {"name": "display_name", "type": "string", "description": "Segment display name"},
            {
                "name": "type",
                "type": "string",
                "description": "Segment type: ROUTED, CONNECTED, DISCONNECTED",
            },
            {
                "name": "transport_zone_path",
                "type": "string",
                "description": "Transport zone this segment belongs to",
            },
            {
                "name": "admin_state",
                "type": "string",
                "description": "Administrative state: UP, DOWN",
            },
            {
                "name": "vlan_ids",
                "type": "array",
                "description": "VLAN IDs for VLAN-backed segments",
            },
        ],
    ),
    TypeDefinition(
        ...
        properties=[
            {"name": "display_name", "type": "string", "description": "Policy display name"},
            {
                "name": "category",
                "type": "string",
                "description": "Policy category: Emergency, Infrastructure, Environment, Application",
            },
            {
                "name": "rule_count",
                "type": "integer",
                "description": "Number of rules in this policy",
            },
        ],
    ),
    TypeDefinition(
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "tier", "type": "string", "description": "Gateway tier: Tier-0 or Tier-1"},
            {
                "name": "ha_mode",
                "type": "string",
                "description": "HA mode: ACTIVE_ACTIVE, ACTIVE_STANDBY",
            },
        ],
    ),
    ...
    TypeDefinition(
        ...
        properties=[
            {"name": "name", "type": "string", "description": "Domain name"},
            {
                "name": "type",
                "type": "string",
                "description": "Domain type: MANAGEMENT, VI (workload)",
            },
    ...
    TypeDefinition(
        ...
        properties=[
            {"name": "fqdn", "type": "string", "description": "Host fully qualified domain name"},
            {
                "name": "status",
                "type": "string",
                "description": "Host status: ASSIGNED, UNASSIGNED_USEABLE",
            },
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "valid_to", "type": "string", "description": "Certificate expiration date"},
            {
                "name": "is_installed",
                "type": "boolean",
                "description": "Whether certificate is currently installed",
            },
        ],
    ),
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "capacity_gb", "type": "number", "description": "Total vSAN capacity in GB"},
            {
                "name": "free_space_gb",
                "type": "number",
                "description": "Available vSAN space in GB",
            },
            {
                "name": "disk_group_count",
                "type": "integer",
                "description": "Number of disk groups across all hosts",
            },
        ],
    ),
]
