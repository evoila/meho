...
NAME_OF_DATASTORE = "Name of datastore"
...
STORAGE_OPERATIONS = [
    ...
    OperationDefinition(
        ...
        response_entity_type="VirtualDisk",
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": "Path within datastore (default: root)",
            },
        ],
        example="browse_datastore(datastore_name='datastore1', path='/vm-templates')",
        response_entity_type="FileInfo",
        response_identifier_field="path",
        response_display_name_field="path",
    ),
    OperationDefinition(
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Snapshot to compare against",
            },
            {
                "name": "device_key",
                "type": "integer",
                "required": True,
                "description": "Disk device key",
            },
            {
                "name": "start_offset",
                "type": "integer",
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Change ID from previous query",
            },
        ],
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Current datastore name",
            },
            {
                "name": "new_name",
                "type": "string",
                "required": True,
                "description": "New datastore name",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Datastore path to VMDK file",
            },
            {
                "name": "controller_key",
                "type": "integer",
                "required": False,
                "description": "Controller device key",
            },
            {
                "name": "unit_number",
                "type": "integer",
                "required": False,
                "description": "Unit number on controller",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Label of disk to detach (e.g., 'Hard disk 2')",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "boolean",
                "required": False,
                "description": "Use thin provisioning (default: True)",
            },
            {
                "name": "datastore_name",
                "type": "string",
                "required": False,
                "description": "Target datastore (default: VM's datastore)",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Label of disk to extend (e.g., 'Hard disk 1')",
            },
            {
                "name": "new_size_gb",
                "type": "integer",
                "required": True,
                "description": "New disk size in GB (must be larger than current)",
            },
        ],
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of datastore to destroy",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name for new datastore",
            },
            {
                "name": "device_path",
                "type": "string",
                "required": True,
                "description": "Device path (e.g., 'naa.xxx')",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": False,
                "description": "Access mode: readWrite, readOnly (default: readWrite)",
            },
        ],
    ...
    OperationDefinition(
        ...
        parameters=[
            ...
            },
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of datastore to remove",
            },
        ],
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of VMFS datastore",
            },
        ],
    ...
    OperationDefinition(
        ...
        response_entity_type="StoragePod",
        response_identifier_field="moref_id",
        response_display_name_field="name",
    ),
    OperationDefinition(
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": "Name of storage pod",
            },
        ],
