...
class ClusterHandlerMixin:
    ...
    def _serialize_cluster_properties(self, _cluster: Any) -> dict[str, Any]:
        return {}

    async def _list_clusters(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    def _format_cluster_from_properties(
        self, obj: Any
