...
class SystemHandlerMixin:
    ...
    async def _get_vcenter_info(self, _params: dict[str, Any]) -> dict:
    ...
    async def _list_alarms(self, _params: dict[str, Any]) -> list[dict]:
    ...
    async def _get_license_info(self, _params: dict[str, Any]) -> dict:
    ...
    async def _get_licensed_features(self, _params: dict[str, Any]) -> list[str]:
