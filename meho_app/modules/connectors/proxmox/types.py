...
CURRENT_CPU_USAGE_PERCENTAGE = "Current CPU usage percentage"
MEMORY_USED_IN_MB = "Memory used in MB"
TOTAL_MEMORY_IN_MB = "Total memory in MB"
...
PROXMOX_TYPES = [
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "status", "type": "string", "description": "Node status: online, offline"},
            {
                ...
                "type": "float",
                "description": CURRENT_CPU_USAGE_PERCENTAGE,
            },
            {"name": "memory_used_mb", "type": "integer", "description": MEMORY_USED_IN_MB},
            {"name": "memory_total_mb", "type": "integer", "description": TOTAL_MEMORY_IN_MB},
    ...
    TypeDefinition(
        ...
        properties=[
            ...
            {"name": "memory_mb", "type": "integer", "description": TOTAL_MEMORY_IN_MB},
            {"name": "memory_used_mb", "type": "integer", "description": MEMORY_USED_IN_MB},
