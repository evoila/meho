...
class MonitoringHandlerMixin:
    ...
    def _get_project_name(self: "GCPConnector") -> str:
    ...
    async def _handle_list_metric_descriptors(
    ...
    async def _handle_get_metric_descriptor(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_get_time_series(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_instance_metrics(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_alert_policies(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """List alert policies."""
        filter_str = params.get("filter")
    ...
    async def _handle_get_alert_policy(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_notification_channels(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_list_uptime_checks(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
