...
class StorageHandlerMixin:
    ...
    async def _handle_list_azure_storage_accounts(  # type: ignore[misc]
        ...
        if resource_group:
            async for account in self._storage_client.storage_accounts.list_by_resource_group(
                resource_group
            ):
    ...
    async def _handle_get_azure_storage_account(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_blob_containers(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
            ...
            results.append(
                {
                    ...
                    "last_modified": str(container.last_modified_time)
    ...
    async def _handle_list_azure_managed_disks(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_azure_storage_account_keys(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_storage_usage(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
