...
async def db_session() -> AsyncGenerator:
    ...
    try:
        from meho_app.modules.knowledge.models import Base as knowledge_base_cls
    except ImportError:
        knowledge_base_cls = None

    try:
        from meho_app.modules.connectors.models import Base as connectors_base_cls
    except ImportError:
        connectors_base_cls = None

    try:
        from meho_app.modules.agents.models import Base as agent_base_cls
    except ImportError:
        agent_base_cls = None
