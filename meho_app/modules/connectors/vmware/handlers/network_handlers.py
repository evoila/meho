...
class NetworkHandlerMixin:
    ...
    def _find_network(self, _name: str) -> Any | None:
        return None

    def _find_dvs(self, _name: str) -> Any | None:
        return None
    ...
    def _serialize_dvs_properties(self, _dvs: Any) -> dict[str, Any]:
        return {}

    def _serialize_portgroup_properties(self, _pg: Any) -> dict[str, Any]:
        return {}

    async def _list_networks(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    async def _list_distributed_switches(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    def _format_dvs_from_properties(
        self, obj: Any
    ...
    async def _list_port_groups(self, _params: dict[str, Any]) -> list[dict]:
        """
