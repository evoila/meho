...
class NetworkHandlerMixin:
    ...
    async def _handle_list_azure_vnets(  # type: ignore[misc]
    ...
    async def _handle_get_azure_vnet(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_subnets(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_list_azure_nsgs(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
    ...
    async def _handle_get_azure_nsg(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_load_balancers(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """List load balancers.
    ...
    async def _handle_get_azure_load_balancer(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_azure_public_ips(  # type: ignore[misc]
        self: "AzureConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
