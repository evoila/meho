...
"""
Alembic environment configuration for the audit module.
"""
...
# .../meho_app/modules/audit/alembic/env.py -> .../
sys.path.insert(
    0,
    os.path.dirname(
        os.path.dirname(
...
from meho_app.modules.audit.models import AuditEvent  # noqa: F401

SQLALCHEMY_URL_KEY = "sqlalchemy.url"

# Use module-specific version table to avoid conflicts with other modules
VERSION_TABLE = "alembic_version_meho_audit"
