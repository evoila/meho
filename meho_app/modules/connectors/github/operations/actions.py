...
REPOSITORY_NAME_WITHOUT_ORG_PREFIX = "Repository name (without org prefix)"
REPO_MY_SERVICE_RUN_ID_12345678 = '{"repo": "my-service", "run_id": 12345678}'
...
ACTION_OPERATIONS = [
        ...
        parameters=[
            {
                ...
                "type": "string",
                "required": True,
                "description": REPOSITORY_NAME_WITHOUT_ORG_PREFIX,
            },
            {
                "name": "status",
                "type": "string",
    ...
    OperationDefinition(
        ...
        example=REPO_MY_SERVICE_RUN_ID_12345678,
        response_entity_type="WorkflowRun",
        response_identifier_field="id",
        response_display_name_field="name",
    ),
