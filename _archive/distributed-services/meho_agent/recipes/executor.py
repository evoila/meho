...
from meho_agent.data_reduction.engine import DataReductionEngine
from meho_agent.data_reduction.query_schema import DataQuery, ReducedData
...
class RecipeExecutor:
    ...
    async def execute(
        ...
        try:
            ...
            result = self.data_engine.execute(api_response, query)
        ...
        for param in recipe.parameters:
            ...
            if name in values:
                ...
                raise RecipeExecutionError(
                    f"Required parameter '{param.display_name}' is missing"
                )
            else:
    ...
    def _validate_type(
        ...
        if expected_type == "string":
            ...
            try:
                ...
                raise RecipeExecutionError(
                    f"Parameter '{display_name}' must be a number"
                )
