...
class TestSOAPSchemaIngesterIntegration:
    ...
    @pytest.mark.skip(reason="Requires zeep and network access")
    async def test_ingest_public_wsdl(self, ingester):
        """Test ingesting a public WSDL (network required)"""
        # This test would use a known public WSDL for testing
        # e.g., http://www.dneonline.com/calculator.asmx?WSDL
        pass
