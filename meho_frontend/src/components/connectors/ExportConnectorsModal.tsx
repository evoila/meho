...
export function ExportConnectorsModal({ onClose, onSuccess }: ExportConnectorsModalProps) {
  // Selection state
                  ...
                  {connectors.map((connector: Connector) => (
                    ...
                    >
                      ...
                      <span className={clsx(
                        ...
                        connector.connector_type === 'vmware' ? "bg-emerald-500/10 text-emerald-400" :
                        connector.connector_type === 'proxmox' ? "bg-orange-500/10 text-orange-400" :
                        connector.connector_type === 'kubernetes' ? "bg-blue-500/10 text-blue-400" :
                        connector.connector_type === 'gcp' ? "bg-sky-500/10 text-sky-400" :
          ...
          >
            {exporting ? (
              ...
              <>
                ...
                Export {selectedIds.size > 0 ? `${selectedIds.size} Connector${selectedIds.size > 1 ? 's' : ''}` : ''}
              </>
            )}
          </button>
        </div>
