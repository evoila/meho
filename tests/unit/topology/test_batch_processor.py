...
class TestBatchProcessorSingleton:
    ...
    def test_get_processor_requires_session_maker(self):
        ...
        with pytest.raises(ValueError, match="session_maker is required"):
            get_batch_processor(queue=queue)
    ...
    @pytest.mark.asyncio
    def test_get_processor_instance_returns_instance(self):
