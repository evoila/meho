...
async def override_operation(
    ...
    if existing_override is not None:
        ...
        existing_override.search_content = " ".join(
            filter(
                None,
                [
                    existing_override.name or "",
                    existing_override.operation_id or "",
                    existing_override.description or "",
                    existing_override.category or "",
                ],
            )
        )
    ...
    override_op.search_content = " ".join(
        filter(
            None,
            [
                override_op.name or "",
                override_op.operation_id or "",
                override_op.description or "",
                override_op.category or "",
            ],
        )
    )
