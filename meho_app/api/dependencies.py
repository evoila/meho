...
async def get_knowledge_service_dep(session: DbSession) -> KnowledgeService:
    """Get KnowledgeService instance for the current request."""
    return get_knowledge_service(session)


async def get_openapi_service_dep(session: DbSession) -> OpenAPIService:
    """Get OpenAPIService instance for the current request."""
    return get_openapi_service(session)


async def get_agent_service_dep(session: DbSession) -> AgentService:
    """Get AgentService instance for the current request."""
    return get_agent_service(session)


async def get_ingestion_service_dep(session: DbSession) -> IngestionService:
...
async def create_agent_state_store() -> AgentStateStore:
    """
