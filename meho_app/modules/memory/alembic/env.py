...
"""
Alembic environment configuration for meho_memory.
"""
...
# .../meho_app/modules/memory/alembic/env.py -> .../
sys.path.insert(
    0,
    os.path.dirname(
        os.path.dirname(
