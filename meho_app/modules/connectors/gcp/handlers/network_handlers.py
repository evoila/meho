...
class NetworkHandlerMixin:
    ...
    async def _handle_list_networks(
    ...
    async def _handle_get_network(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_list_subnetworks(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """List subnetworks."""
        from google.cloud import compute_v1
    ...
    async def _handle_get_subnetwork(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_list_firewalls(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """List firewall rules."""
        from google.cloud import compute_v1
    ...
    async def _handle_get_firewall(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_list_addresses(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
