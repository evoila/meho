...
"""
Alembic environment configuration for meho_topology.
"""
...
# .../meho_app/modules/topology/alembic/env.py -> .../
sys.path.insert(
    0,
    os.path.dirname(
        os.path.dirname(
