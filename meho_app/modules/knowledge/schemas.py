...
class ChunkMetadata(BaseModel):
    ...
    document_name: str | None = Field(default=None, description="Original document filename or URL")
    page_number: int = Field(default=0, description="Primary source page (0 if unknown)")
    page_numbers: list[int] = Field(
        default_factory=list,
        description="All source pages touched by this chunk",
    )
    page_start: int = Field(default=0, description="First source page covered by the chunk")
    page_end: int = Field(default=0, description="Last source page covered by the chunk")
...
class KnowledgeChunkCreate(BaseModel):
    ...
    doc_version: str | None = Field(
        default=None, description="Documentation version label (e.g. 'v8', 'v9', '2026.1')"
    )
    family_id: str | None = Field(
        default=None, description="Document family identifier (groups all versions of a doc)"
    )
