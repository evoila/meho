...
import type { Connector, UpdateConnectorRequest } from '@/api/types';
...
export function ConnectorSettings({ connector, onUpdate, allConnectors = [] }: Readonly<ConnectorSettingsProps>) {
