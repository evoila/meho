        ...
        "matches": [
            {
                "text": m.get("text"),
                "ts": m.get("ts"),
                "channel": m.get("channel", {}).get("name") if isinstance(m.get("channel"), dict) else m.get("channel"),
                "channel_id": m.get("channel", {}).get("id") if isinstance(m.get("channel"), dict) else None,
                "user": m.get("user"),
