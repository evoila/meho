...
class TEIReranker:
    ...
    def __init__(self, base_url: str = "http://tei-reranker:80") -> None:
    ...
    if _reranker is None:
        try:
            ...
            if config.voyage_api_key:
                ...
                _reranker = TEIReranker(base_url=config.tei_reranker_url)  # type: ignore[attr-defined]  # Config field defined via pydantic-settings env var
        except Exception as e:
            logger.warning(
