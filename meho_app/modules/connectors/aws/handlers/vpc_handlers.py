...
class VPCHandlerMixin:
    ...
    async def _handle_list_vpcs(  # type: ignore[misc]
    ...
    async def _handle_get_vpc(self: "AWSConnector", params: dict[str, Any]) -> dict[str, Any]:  # type: ignore[misc]
        """
    ...
    async def _handle_list_subnets(  # type: ignore[misc]
        self: "AWSConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
        """
