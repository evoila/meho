...
class ComputeHandlerMixin:
    ...
    async def _handle_get_instance(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_stop_instance(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
        """Stop an instance."""
        from google.cloud import compute_v1
    ...
    async def _handle_reset_instance(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_get_instance_serial_port_output(
        self: "GCPConnector", params: dict[str, Any]
    ) -> dict[str, Any]:
    ...
    async def _handle_get_disk(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
        """Get disk details."""
        from google.cloud import compute_v1
    ...
    async def _handle_get_snapshot(self: "GCPConnector", params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _handle_list_machine_types(
        self: "GCPConnector", params: dict[str, Any]
    ) -> list[dict[str, Any]]:
