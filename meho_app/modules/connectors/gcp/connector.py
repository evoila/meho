...
class GCPConnector(
    ...
    @property
    def project_id(self) -> str:  # type: ignore[override]
        """Get the GCP project ID."""
        return self._project_id or ""

    @property
    def default_region(self) -> str:  # type: ignore[override]
        """Get the default region."""
        return str(self._default_region)

    @property
    def default_zone(self) -> str:  # type: ignore[override]
        """Get the default zone."""
        return str(self._default_zone)
    ...
    def _parse_gcp_error(self, error: Exception, operation_id: str) -> dict[str, Any]:
        ...
        if isinstance(error, KeyError):
            ...
            return {
                ...
                "message": (
                    f"Operation '{operation_id}' is missing required parameter "
                    f"'{missing_key}'. Check the operation definition for correct "
                    f"parameter names."
                ),
                "details": {
                    "error_type": error_type,
