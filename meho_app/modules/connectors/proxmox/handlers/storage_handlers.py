...
class StorageHandlerMixin:
    ...
    async def _list_storage(self, params: dict[str, Any]) -> list[dict]:
    ...
    async def _get_storage(self, params: dict[str, Any]) -> dict[str, Any]:
    ...
    async def _get_storage_content(self, params: dict[str, Any]) -> list[dict[str, Any]]:
    ...
    async def _get_storage_status(self, params: dict[str, Any]) -> dict[str, Any]:
