...
async def test_bm25_enforces_tenant_isolation(knowledge_repository, tenant_a, tenant_b):
    """
    **Security Test P0**
...
@pytest.mark.integration
@pytest.mark.security
async def test_bm25_enforces_role_restrictions(knowledge_repository, tenant_a):
    """
    **Security Test P0**
...
@pytest.mark.integration
@pytest.mark.security
async def test_bm25_enforces_group_restrictions(knowledge_repository, tenant_a):
    """
    **Security Test P0**
...
@pytest.mark.integration
@pytest.mark.security
async def test_bm25_acl_with_multiple_conditions(knowledge_repository, tenant_a):
    """
    **Security Test P0**
...
@pytest.mark.integration
@pytest.mark.security
async def test_bm25_acl_empty_results_for_unauthorized(knowledge_repository):
    """
    **Security Test P0**
