...
def serialize_vm_properties(vm: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
    """
...
def serialize_host_properties(host: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
    """
...
def serialize_datastore_properties(ds: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
    """
...
def serialize_cluster_properties(cluster: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
    """
...
def serialize_dvs_properties(dvs: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
    """
...
def serialize_datacenter_properties(dc: Any) -> dict[str, Any]:  # NOSONAR (cognitive complexity)
