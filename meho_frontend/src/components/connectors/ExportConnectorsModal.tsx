...
import type { Connector, ExportFormat } from '@/api/types';
...
export function ExportConnectorsModal({ onClose, onSuccess }: ExportConnectorsModalProps) { // NOSONAR (cognitive complexity)
  ...
  const handleExport = useCallback(async () => {
    ...
    try {
      const blob = await connectorsClient.exportConnectors({
  ...
  }, [canExport, selectedIds, password, format, connectorsClient, onSuccess, onClose]);
