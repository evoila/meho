...
export function ConnectionTest({ // NOSONAR (cognitive complexity)
  connector,
  credentialStatus
  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (isSessionAuth) {
        ...
        testResult = await connectorsClient.testAuth(connector.id, {});
      } else {
        // For other auth types: test connection
        testResult = await connectorsClient.testConnection(connector.id, {
