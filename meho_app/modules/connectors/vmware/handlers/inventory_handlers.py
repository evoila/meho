...
class InventoryHandlerMixin:
    ...
    def _serialize_datacenter_properties(self, _dc: Any) -> dict[str, Any]:
        return {}

    def _serialize_resource_pool_properties(self, _pool: Any) -> dict[str, Any]:
        return {}

    def _serialize_folder_properties(self, _folder: Any) -> dict[str, Any]:
        return {}

    async def _list_datacenters(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    async def _list_resource_pools(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    async def _list_folders(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    async def _get_content_library_items(self, _params: dict[str, Any]) -> list[dict]:
    ...
    async def _deploy_library_item(self, _params: dict[str, Any]) -> dict:
    ...
    async def _list_tags(self, _params: dict[str, Any]) -> list[dict]:
        """List all tags."""
    ...
    async def _list_tag_categories(self, _params: dict[str, Any]) -> list[dict]:
        """List tag categories."""
        return [
            {
                "message": "Tag operations require vSphere REST API",
    ...
    async def _list_content_libraries(self, _params: dict[str, Any]) -> list[dict]:
