...
class StorageHandlerMixin:
    ...
    async def _list_datastores(self, _params: dict[str, Any]) -> list[dict]:
        """
    ...
    def _format_datastore_from_properties(
        self, obj: Any
    ...
    async def _browse_datastore(
        self, params: dict[str, Any]
    ) -> list[dict]:  # NOSONAR (cognitive complexity)
    ...
    async def _get_storage_pods(self, _params: dict[str, Any]) -> list[dict]:
